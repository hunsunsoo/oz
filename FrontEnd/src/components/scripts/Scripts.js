...
const IntrodialogueData = [
...

  {
    ...
    message:(
      <>
        난 스스로 생각을 하지 못하는 허수아비야. 마법사 오즈가 소원을 이루어 준다고 해서 
        <br />
        오즈를 찾아가는 길이야! 근데 어디로 가야 할지 모르겠어…
      </>
    ),
  },
  ...
  // 3
  {
    ...
    message:(
      <>
      좋아! (어 근데 저기 쭈그려있는 사자는 뭐지??) 
      <br />
      엇 .. 사자야 여기서 뭐하고있니?? 우리는 오즈에게 소원을 이뤄달라고 하기 위해 가고있어!
      </>
    ),
  },
...

  {
    ...
    message:(
      <>
        그렇다면, 너희들이 괜찮다면, 나도 함께 가고 싶어. 
        <br />
        조그만 용기도 없는 내 삶은 정말 견딜 수 없어
      </>
    ),
  },
...

  {
    ...
    message:(
      <>
        난 마녀의 저주로 마음를 잃어버렸어.. 난 인간시절 내 심장을 찾고싶어.. 
        <br />
        오즈가 나에게도 심장을 줄 수 있을까?
      </>
    ),
  },
  {
...
const dialogue3Data = [
...

  {
    ...
    message:(
      <>
        .. 너희가 나를 구해준거니? 정말 고마워 너희의 따뜻한 마음에 감동받았어 
        <br />
        우리 어서 마녀를 잡으러가자!!!
      </>
    ),
